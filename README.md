...
[![Test](https://github.com/seanghay/skia-web/actions/workflows/test.yml/badge.svg)](https://github.com/seanghay/skia-web/actions/workflows/test.yml)

![output](examples/node/output.svg)

<sub>Generated by <a href="examples/node/index.js">examples/node/index.js</a></sub>

- WebGL GPU surfaces available in browsers
- SVG document parsing and rendering with SVGDOM
