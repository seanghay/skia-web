...
export interface CanvasKit {
    ...
    readonly SVGCanvas: {
         ...
         * @param width
         * @param height
         * @param flags - Flags for SVG generation.
         */
    ...
    readonly PDFDocument: {
         ...
         * @param metadata
         */
        new (metadata: PDFMetadata): PDFDocument;
    };

    readonly PDFMetadata: {
        /**
         * Constructs a new PDFMetadata object with default values.
         */
        new (): PDFMetadata;
    };

    // Value Object (Simple JS object return)
...
export interface PDFMetadata {
    ...
    subject: string;
    creator: string;
    creation: PDFDateTime;
    modified: PDFDateTime;
    rasterDPI: number;
    pdfA: boolean;
    encodingQuality: number;
    allowNoJpegs: boolean;
}

/**
 * Represents a date and time used in PDF metadata.
 */
export interface PDFDateTime {
    year: number;
    month: number;
    day: number;
    hour: number;
...
/**
 * SVGCanvas is a class that captures drawing commands and outputs SVG data.
 */
export interface SVGCanvas extends EmbindObject<"SVGCanvas"> {
    /**
     * Returns a canvas that will draw to the SVG.
     */
    getCanvas(): Canvas;
